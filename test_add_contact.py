...
class TestAddGroup(unittest.TestCase):
    ...
    def create_contact(self, wd):
        ...
        wd.find_element_by_name("lastname").send_keys(u"Иванович")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys(u"Ванечка")
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys(u"Мир, дружба")
        wd.find_element_by_name("address").click()
        wd.find_element_by_name("address").clear()
        wd.find_element_by_name("address").send_keys(u"г. Екатеринбург, ул. Широкая речка, д. 5")
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        wd.find_element_by_name("home").send_keys("83433000102")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("89001234567")
    ...
    def open_home_page(self, wd):
        wd.get("http://macbook-air-anna.localhost/addressbook/group.php")
